...
import OrderHistoryDate from "../../components/OrderHistoryDate/OrderHistoryDate";
    ...
    <section className="bg-[#FFFFFF] min-h-screen pt-10 mb-80 w-full">
      <div className=" mx-auto">
        <div className=" w-full">
          ...
          <div className=" flex lg:justify-between flex-wrap gap-2 relative z-10 mt-8">
            <div className="flex">
          ...
          <div
            className={`rounded-lg w-full  pb-10 ${style.boxshaddow} bg-[#FFFFFF] absolute lg:top-[436px] `}
          >
            <div className="p-6">
              <div className="mb-4">
