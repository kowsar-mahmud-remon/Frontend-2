                            ...
                            <div className=' flex items-center md:w-[55%]'>
                                <div className='md:px-[86px] px-[28px]  w-full'>
                                    ...
                                    <form
                                        ...
                                        <Link href='/sellerLogin/sellerOtp' className=''>  <button className=' rounded-[8px] w-[100%] bg-[#FB641B] hover:bg-[#FB641B]  text-[18px] md:h-[3.7vw]  text-white md:mt-[1vw]'>Forgot Password</button></Link>
