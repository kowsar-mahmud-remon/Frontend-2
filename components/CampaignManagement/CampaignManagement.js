...
const CampaignManagement = () => {
  ...
  return (
    <div className="mt-7">
      ...
      <div
        className={`lg:w-[1426px] mx-auto mt-8 h-screen ${styles.campaignManagementWithoutBorder}`}
      >
        <div
          className={`p-8 flex flex-wrap gap-4 justify-center lg:justify-start`}
        >
          {productDetails.map((product) => (
            <div
              key={product._id}
              className={`w-[183px] p-2 ${styles.campaignManagementWithoutBorder}`}
            >
              <div className=" flex justify-end mb-[-25px] mr-1">
                <div className="dropdown dropdown-end">
                  ...
                  <ul
                    tabIndex={0}
                    className="dropdown-content menu shadow bg-base-100 rounded border border-[#B7B7B7] w-[121px] text-base text-[#686868]"
                  >
                    <li>
                      <Link href="campaignManagementOne">View Detail</Link>
                    </li>
                    <li>
                      <Link href="campaignManagementTwo">Edit</Link>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <div
            className={`w-[183px] ${styles.campaignManagementWithoutBorder}`}
          >
            <Image
