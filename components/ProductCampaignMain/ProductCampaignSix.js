...
const ProductCampaignSix = () => {
  return (
    <div className='mt-7 p-4 lg:p-0'>
      ...
      <div className={`lg:w-[642px] mx-auto pt-[90px] ${styles.campaignManagement}`}>
        ...
        <div className="flex justify-center">
          ...
          <div className="text-center">
            ...
            <p className='text-base text-[#686868] w-[436px]'>After review, your asset can run if it has one of these statuses</p>
          </div>

        </div>

        <div className="flex justify-center">
          <div className="mb-[90px] mx-auto">
      ...
      <div className="flex justify-center mt-8">
        <Link href="allProduct">
          <label htmlFor="my-modal-4" className="btn bg-[#FB641B] text-white w-[264px] h-[72px] normal-case text-2xl font-normal">Back to Home</label>
        </Link>
      </div>
...
export default ProductCampaignSix;