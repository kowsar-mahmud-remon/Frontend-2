...
import verify from '../../../assets/images/uploadproducts/Verified.png'
    ...
    return (
      <div>
        <div
          ...
          className={` w-[180px] md:w-[240px] h-auto cursor-pointer rounded-md pb-4  duration-[.3s] rounded-md`}
        >
          <div className="">
            <div className="relative ">
              ...
              <div className="absolute top-3 right-[25px] bg-white rounded-full p-3 w-[38px] h-[38px] flex justify-center items-center cursor-pointer">
                <Image src={verify} width={30} alt="img" />
              </div>
            </div>
            <div className="px-4 mt-1">
              ...
              <div className="flex justify-center mt-6">
                <button className="bg-[#FB641B] text-white w-[90%] flex justify-center items-center rounded-[10px] font-[500] text-[14px] md:text-[23px] gap-2 py-1 ">
                  Add to Cart{" "}
                  <span>
                    <Image src={verify} alt="cart" width={20} height={21} />
                  </span>
                </button>
              </div>
            </div>
