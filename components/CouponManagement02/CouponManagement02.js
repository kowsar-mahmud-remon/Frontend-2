        ...
        <div className='md:mt-[45px]'>
            ...
            <div className='shadow-small  rounded-md max-w-[1426px]'>
                ...
                <div className='flex justify-center gap-4 pb-[16px]'>
                    ...
                    <Link href='couponmanagement03' >   <button className=' font-normal border border-[#FB641B] bg-[#FB641B] rounded-[4px]  text-white text-[16px] w-[134px] h-[40px]'>Buy Now</button></Link>
                </div>
            </div>
        </div>
    );
