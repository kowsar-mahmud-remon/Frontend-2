...
import { FaAngleLeft, FaAngleRight, FaArrowLeft, FaRegSmile } from "react-icons/fa";
                ...
                <div className="reviewResponsive w-full h-[113px] mt-[28px]">
                  <div className="">
                    <div className="flex justify-between mx-[12px]">
                      <div>
                        <p className="font-normal  pt-[12px] text-[#001E00] text-[12px]">Banglar Big Store</p>
                        <p className="text-[#686868] mt-[4px]  font-normal text-[12px]">Placed On 21 Dce 2022 10:21:00</p>
                      </div>
                      <Link className="text-[14px] mt-[16px] text-[#FB641B] font-normal  italic" href="/profile/writeReview">REVIEW</Link>
                    </div>
