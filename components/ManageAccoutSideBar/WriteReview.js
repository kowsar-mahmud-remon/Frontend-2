    ...
    <div>
      <div className="lg:block hidden lg:mr-[20px]">
        ...
        <div className="md:block hidden">
          ...
          <div className="max-w-[924px] flex h-full left-[636px] mt-[26px] top-[297px]  shadowreviews">
            <div className="grid grid-cols-12 ">
              <div className="max-w-[600px] col-span-7">
                ...
                <div className="">
                  <textarea className="resize-none p-[24px] font-[400] text-[16px] text-[#686868] w-full xl:w-[552px] ml-[24px] h-[96px] bg-[#F2F2F2] rounded-lg outline-none "></textarea>
                </div>
              ...
              <div className="divider col-span-1 xl:ml-[50px] ml-[30px] divider-horizontal mt-[29px] h-[460px]"></div>
              <div className="max-w-[324px] lg:mr-[24px] col-span-4">
                ...
                <div className="mt-[32px]">
                  ...
                  <textarea className=" resize-none  p-[12px] font-[400] text-[16px] text-[#686868] w-full xl:w-[275px] mt-[8px] h-[72px] bg-[#F2F2F2] rounded-[4px] outline-none"></textarea>
                </div>
                ...
                <div className="mt-[55px]">
                  <div className="flex xl:gap-[26px] gap-[10px] items-center">
                    <p className="font-[400] whitespace-nowrap text-[14px] xl:text-[16px] text-[#001E00]">
                      Review as Abdul K.
                    </p>
                    <div className="flex xl:gap-[8px] gap-[4px] items-center">
                      <label class="switch xl:w-[42px] xl:h-[24px] lg:w-[35px] lg:h-[22px]">
                        <input type="checkbox" />
                        <span class="slider round"></span>
                      </label>
                      <p className="text-[#287DF3] text-[11px] xl:text-[12px] font-[400]">
                        Anonymous
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-[20px] mb-[10px]">
                  <button className="bg-[#FB641B] mb-[32px] text-white w-full xl:w-[275px] h-[48px] rounded-[8px]">
                    Submit
                  </button>
                </div>
              </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-[16px] mt-[16px]">
              <div className="flex items-center gap-[24px]">
                ...
                <FaRegMeh className="w-full h-[36px] hover:text-[#FB641B]"></FaRegMeh>
                <FaRegSmile className="w-full h-[36px] hover:text-[#FB641B]"></FaRegSmile>
              </div>
              <p className="font-[400] text-[16px] text-[#686868]">Positive</p>
            </div>
          </div>
