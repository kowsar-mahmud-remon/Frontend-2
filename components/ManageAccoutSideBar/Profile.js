                ...
                <div className="mt-[34px] px-[24px] w-full">
                    ...
                    <div>
                        ...
                        <div className="mt-[20px] w-full">
                            ...
                            <div className="">
                                <input placeholder='Male' className="text-[#686868]  w-full mt-[12px] h-[48px] bg-[#FFFFFF] rounded-[4px] profileBox  pl-[16px] text-[16px] font-[400]"></input>
                            </div>
                        </div>
                        <div className="mt-[24px]">
                            <label htmlFor='Newsletter-responsive-modal-3'>
                                <h1 className="text-[#287DF3] text-[16px]">Subscribe to our Newsletter</h1>
                            </label>
                        </div>
