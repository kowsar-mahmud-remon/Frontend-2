                ...
                <div className="mt-[34px] px-[24px] w-full">
                    ...
                    <div>
                        <div className="mt-[16px] w-full">
                            <h1 className="text-[#686868] text-[14px] font-normal">Current Password</h1>
                            <div className="">
                                <input placeholder='Type Current Password' className="text-[#686868]  pl-[16px] text-[16px] placeholder:text-[14px] font-[400] w-full mt-[12px] h-[48px] bg-[#FFFFFF] rounded-[4px] profileBox placeholder:text-[#686868]"></input>
                            </div>
                        </div>
                        <div className="mt-[20px] w-full">
                            <h1 className="text-[#686868] text-[14px] font-normal">New Password</h1>
                            <div className="">
                                <input placeholder='Minimum 6 Character With a Number and a Latter' className="text-[#686868] placeholder:w-full  pl-[16px] text-[16px] placeholder:text-[14px] font-[400] w-full mt-[12px] h-[48px] bg-[#FFFFFF] rounded-[4px] profileBox placeholder:text-[#686868]"></input>
                            </div>
                            <div className="mt-[12px] flex gap-[12px] items-center">
                                <input type="checkbox" className="w-[19px] h-[19px] rounded-[3px] border-solid box-border border-[#B7B7B7]" />
                                <h1 className="text-[#686868] text-[16px] font-[400]">Show Password</h1>
                        ...
                        <div className="mt-[20px] w-full">
                            <h1 className="text-[#686868] text-[14px] font-normal">Retype Password</h1>
                            <div className="">
                                <input placeholder='Please Retype your Password' className="text-[#686868] placeholder:w-full  pl-[16px] text-[16px] placeholder:text-[14px] font-[400] w-full mt-[12px] h-[48px] bg-[#FFFFFF] rounded-[4px] profileBox placeholder:text-[#686868]"></input>
                            </div>
                            <div className="mt-[12px] flex gap-[12px] items-center">
                                <input type="checkbox" className="w-[19px] h-[19px] rounded-[3px] border-solid box-border border-[#B7B7B7]" />
                                <h1 className="text-[#686868] text-[16px] font-[400]">Show Password</h1>
                        ...
                        <div className='flex justify-between gap-[20px] mt-[350px] w-full'>
