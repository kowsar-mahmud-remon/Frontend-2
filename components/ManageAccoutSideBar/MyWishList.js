...
import { FaArrowLeft, FaHeart, FaRegHeart, FaStar, FaTrashAlt } from "react-icons/fa";
                ...
                <div className="mt-[34px] px-[24px] w-full">
                    <div>
                        <button onClick={() => router.back()} className='flex items-center gap-[13px]'>
                            ...
                            <h1 className='text-[20px]  font-[500] text-[#001E00]'>My Wishlist</h1>
                        </button>
                    </div>
                    <div className="mt-[16px]">
                        <div className="w-full h-full wishlistResponsiveBox">
                            <div className="mx-[12px] ">
                                <h1 className="text-[#686868] pt-[12px] text-[14px]">Purchased on: 21 Dce 2022 10:21:00</h1>
                                <div className="flex items-center  justify-between gap-[15px]">
                                    <div className="flex">
                                        <Image src='/image 8.png' width={79} height={63} alt=""></Image>
                                        <div>
                                            <h1 className="text-[16px] text-[#001E00]">Tomato (Local) 500...</h1>
                                            <h1 className="text-[#FB641B] text-[16px] font-[500]">Tk. 60</h1>
                                    ...
                                    <div className="mb-[10px]">
                                        <div className="w-[66px] flex items-center h-[28px] mt-[10px]  bg-[#FB641B] rounded-[26px]">
                                            <Image src='/shopingcart.png' className=" ml-[24px]" width={19} height={16} alt=""></Image>
                                        </div>
                    ...
                    <div className="mt-[24px]">
                        <h1 className="text-[#001E00] font-[500] text-[24px]">Just For You</h1>
                        <div className="mt-[16px]">
                            <div className="grid grid-cols-2 gap-[16px]">
                                {
                                    wishlistData.slice(0, 4).map(data => <>
                                        ...
                                        <div className="wishlistcard w-full h-full">
                                            <div>
                                                <label className="flex ">
                                                    <Image src='/image 8.png' width={180} height={126} alt=""></Image>
                                            ...
                                            <div className="ml-[16px]">
                                                <p className="text-[#FB641B] font-[500] text-[18px]">Tk 1024</p>
                                                <p className="text-[#001E00] text-[14px] font-[400] w-full">Misti Kumra Fali (Sweet Pumpkin Fali)</p>
                                                <div className="mt-[10px] flex gap-[8px] items-center">
                                                    <div className="flex gap-[4px] items-center w-[35px] h-[16px] bg-[#026C51] rounded-[2px]">
                                                        <p className="text-[12px] ml-[2px] font-normal text-white">4.9</p>
                                                        <FaStar className="w-[12px] h-[12px] text-white "></FaStar>
                                                    </div>
                                                    <p className="text-[#686868] text-[10px] font-[400]">24 Ratings & 5 Reviews</p>
                                                </div>
                                                <div className="mt-[4px] flex gap-[8px]">
                                                ...
                                                <div className="mx-[20px] mt-[34px] mb-[8px]">
                                                    <button className="w-full flex items-center justify-center gap-[4px] h-[38px] bg-[#FB641B] rounded-[4px]">
                                                       <h1 className="text-[#FFFFFF]  text-[16px] font-[500]">Add to Cart</h1>
                                                       <Image alt="" src='/shopingcart.png' width={21} height={18}></Image>
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
