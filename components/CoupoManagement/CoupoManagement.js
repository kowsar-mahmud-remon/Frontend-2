        ...
        <div>
          <table className={styles.couponTable}>
            ...
            <div className="bg-white max-w-[1426px] justify-center text-center items-center border-b grid lg:grid-cols-10 border-[#B7B7B7] text-[#001E00]">
              ...
              <p className=" font-medium xl:text-[16px] lg:text-[1vw] whitespace-nowrap">
                SAVE50
              </p>
              <p className=" font-medium xl:text-[16px] lg:text-[1vw] whitespace-nowrap">
                50%
              ...
              <p className=" font-medium xl:text-[16px] lg:text-[1vw] whitespace-nowrap text-[#0BD838]">
                Active
              </p>
              ...
              <div className="flex justify-center gap-[8px] items-center">
                <input
                  type="checkbox"
                  className="toggle bg-[#287DF3] toggle-sm"
                />
