...
const AddProductForm = () => {
    return (
        <div className='p-6 border border-[#F2F2F2] shadow-small'>
            ...
            <label htmlFor="thumbnail-file" className="mx-auto cursor-pointer w-full h-[180px] 2xl:h-[200px] mt-8 rounded-xl border-2 border-dashed border-accent bg-white grid grid-cols-4 2xl:grid-cols-5">
                <div className='flex flex-col items-center justify-center'>
                    <svg fill="#FB641B" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-14 w-16"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_iconCarrier"><path d="M13 19v-4h3l-4-5-4 5h3v4z"></path><path d="M7 19h2v-2H7c-1.654 0-3-1.346-3-3 0-1.404 1.199-2.756 2.673-3.015l.581-.102.192-.558C8.149 8.274 9.895 7 12 7c2.757 0 5 2.243 5 5v1h1c1.103 0 2 .897 2 2s-.897 2-2 2h-3v2h3c2.206 0 4-1.794 4-4a4.01 4.01 0 0 0-3.056-3.888C18.507 7.67 15.56 5 12 5 9.244 5 6.85 6.611 5.757 9.15 3.609 9.792 2 11.82 2 14c0 2.757 2.243 5 5 5z"></path></g></svg>

                    <h2 className="mt-2 text-xs 2xl:text-base text-accent tracking-wide">Upload Thumbnail Image </h2>
            ...
            <label htmlFor="productVideo-file" className="mx-auto cursor-pointer w-full h-[180px] 2xl:h-[200px] mt-8 rounded-xl border-2 border-dashed border-accent bg-white grid grid-cols-4 2xl:grid-cols-5">
                <div className='flex flex-col items-center justify-center'>
                    <svg fill="#FB641B" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-14 w-16"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_iconCarrier"><path d="M13 19v-4h3l-4-5-4 5h3v4z"></path><path d="M7 19h2v-2H7c-1.654 0-3-1.346-3-3 0-1.404 1.199-2.756 2.673-3.015l.581-.102.192-.558C8.149 8.274 9.895 7 12 7c2.757 0 5 2.243 5 5v1h1c1.103 0 2 .897 2 2s-.897 2-2 2h-3v2h3c2.206 0 4-1.794 4-4a4.01 4.01 0 0 0-3.056-3.888C18.507 7.67 15.56 5 12 5 9.244 5 6.85 6.611 5.757 9.15 3.609 9.792 2 11.82 2 14c0 2.757 2.243 5 5 5z"></path></g></svg>

                    <h2 className="mt-2 text-xs 2xl:text-base text-accent tracking-wide">Upload Thumbnail Image </h2>
                    <input id="productVideo-file" type="file" className="hidden" />
                </div>
                <div className='col-span-3 2xl:col-span-4 border-l border-accent grid-cols-3 grid 2xl:grid-cols-4 gap-7 p-4'>
                    <div className='w-full h-full bg-slate-300'>
                    </div>
            ...
            <label htmlFor="productImg-file" className="mx-auto cursor-pointer w-full h-[320px] 2xl:h-[400px] mt-8 rounded-xl border-2 border-dashed border-accent bg-white grid grid-cols-4 2xl:grid-cols-5">
                <div className='flex flex-col items-center justify-center'>
                    <svg fill="#FB641B" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="h-14 w-16"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_iconCarrier"><path d="M13 19v-4h3l-4-5-4 5h3v4z"></path><path d="M7 19h2v-2H7c-1.654 0-3-1.346-3-3 0-1.404 1.199-2.756 2.673-3.015l.581-.102.192-.558C8.149 8.274 9.895 7 12 7c2.757 0 5 2.243 5 5v1h1c1.103 0 2 .897 2 2s-.897 2-2 2h-3v2h3c2.206 0 4-1.794 4-4a4.01 4.01 0 0 0-3.056-3.888C18.507 7.67 15.56 5 12 5 9.244 5 6.85 6.611 5.757 9.15 3.609 9.792 2 11.82 2 14c0 2.757 2.243 5 5 5z"></path></g></svg>

                    <h2 className="mt-2 text-xs 2xl:text-base text-accent tracking-wide">Upload Thumbnail Image </h2>
                    <input id="productImg-file" type="file" className="hidden" />
                </div>
                <div className='col-span-3 2xl:col-span-4 border-l border-accent grid-cols-3 grid 2xl:grid-cols-4 gap-7 p-4'>
                    <div className='w-full h-full bg-slate-300'>
                    </div>
            ...
            <div className="flex items-center mt-6">
                <div className="w-1/3">
                    <label className="block text-[#001E00] text-start" htmlFor="ProductName">
                        Product Name:
                    </label>
                </div>
                <div className="w-2/3">
                    <input className="appearance-none border-2 border-accent rounded w-[423px] py-2 px-4 text-accent leading-tight focus:outline-nonefocus:border-primary" id="ProductName" type="text" placeholder="Ex. Nikon Coolpix A300 Digital Camera" />
                </div>
            </div>
            <div className="flex items-center mt-4">
                <div className="w-1/3">
                    <label className="block text-[#001E00] text-start" htmlFor="Bengali_product_name">
                        Bengali product name:
                    </label>
                </div>
                <div className="w-2/3">
                    <input className="appearance-none border-2 border-accent rounded w-[423px] py-2 px-4 text-accent leading-tight focus:outline-nonefocus:border-primary" id="Bengali_product_name" type="text" placeholder="Ex. Nikon Coolpix A300 Digital Camera" />
                </div>
            </div>
            <div className="flex items-center mt-4">
                <div className="w-1/3">
                    <label className="block text-[#001E00] text-start" htmlFor="Category">
                        Category:
                    </label>
                </div>
                <div className="w-2/3">
                    <input className="appearance-none border-2 border-accent rounded w-[423px] py-2 px-4 text-accent leading-tight focus:outline-nonefocus:border-primary" id="Category" type="text" />
                </div>
            </div>
            <div className="flex items-center mt-4">
                <div className="w-1/3">
                    <span className="block text-[#001E00] text-start">
