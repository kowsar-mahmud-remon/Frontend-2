    ...
    <div className="mb-80 lg:flex mx-auto lg:w-[1200px]">
      <div className="lg:mr-6 mb-10 mx-6 lg:mx-0">
        <div className=" mt-6 p-4 lg:w-[788px]">
          ...
          <div className="hidden lg:block border py-2 px-3 mt-6 border-[#B7B7B7] rounded-md">
        ...
        <div className=" mt-4 py-4 mx-4 lg:w-[788px] border-b border-[#B7B7B7]">
...

          {
            products.map(product => <div
              ...
              <div className="lg:flex lg:justify-between items-center w-full">
                ...
                <p className="text-base font-medium inline sm:mr-14 text-[#686868]">Qty: <span className='text-black'>{product.Qty}</span></p>
        ...
        <div className=" p-4 lg:w-[788px]">
          <div className="border border-[#026C51] w-[220px] mt-4 rounded-lg">
            ...
            <div className=" p-3 ml-2 mt-[-25px]">
