  ...
  return (
    <div className="">
      ...
      <div className='lg:w-[1426px] mx-auto p-6 lg:flex mt-8'>
        ...
        <div className="lg:mr-6 mb-5">
          {
            productDetails.map(productImg => <div key={productImg._id} className="lg:w-[96px] p-2 flex flex-wrap">
        ...
        <div className="lg:mr-[38px] mb-10">
          <div className="flex justify-end mb-[-45px] mr-10 h-10">
            <AiFillHeart className=' text-2xl text-[#FB641B] z-10'></AiFillHeart>
          </div>
          <Image
            className='w-[500px] h-[500px] mb-2'
            src={img2}
            alt="Picture of the author"
            width={500}
            height={500}
          ...
          <div className="lg:flex mt-5">
            <button
              className="w-full flex justify-center items-center gap-3 md:btn-md md:w-[240px] h-[53px] bg-[#FF9F00] font-medium text-white rounded-md lg:mr-5 mb-2"
            >Add to Cart <FaShoppingCart className="text-white text-lg mb-1" />
            </button>
            <button
              className="w-full flex justify-center items-center gap-3 md:btn-md md:w-[240px] h-[53px] bg-[#FB641B] font-medium text-white rounded-md mb-2"
