...
const EditProducts = () => {
  ...
  return (
    <div className=''>
      <div className="lg:w-[1426px] mx-auto text-lg text-[#686868] flex items-center mb-2">
      ...
      <div className="lg:w-[1426px] mx-auto">
            ...
            productDetails.map(product => <div key={product._id} className="w-[183px] p-2">
              <div className=" flex justify-end">
                <div className="dropdown dropdown-end">
                  ...
                  <ul tabIndex={0} className="dropdown-content menu shadow bg-base-100 rounded border w-[121px]">
