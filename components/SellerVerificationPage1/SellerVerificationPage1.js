        ...
        <div className='w-[1426px]'>
          ...
          <div className=" p-6 mt-12">
              ...
              <div className="grid gap-5 grid-cols-2 lg:grid-cols-2">
                <div className="mt-10">
                  <label className="label">
                    <span className="label-text text-base font-normal">Shop Name*</span>
                  </label>
                  <input type="text" placeholder="Your shop name" className="input input-bordered w-[680px] h-[72px]" />
                </div>

                <div className=" mt-10">
                  <label className="label">
                    <span className="label-text text-base font-normal">Phone Number*</span>
                  </label>
                  <input type="number" placeholder="+880 123 456 789" className="input input-bordered w-[678px] h-[72px]" />
                </div>

                <div className=" mt-10">
                  <label className="label">
                    <span className="label-text text-base font-normal">Email Address*</span>
                  </label>
                  <input type="email" placeholder="Verified Email" className="input input-bordered w-[678px] h-[72px]" />
                </div>
              </div>
            ...
            <div className=" mt-[78px]">
              ...
              <p className='text-[#686868] mt-9'>Join courses and tutorials to grow your business online</p>
              <div className=" mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div className="">
                  <Image
                    ...
                    height={154}
                  />
                  <p className=' text-base text-[#686868] mt-2'>Seller signup rejection reasons</p>
                </div>
                <div className="">
                  <Image
                    className=' mr-4'
            ...
            <div className=" mt-[78px] grid grid-cols-1 lg:grid-cols-2 gap-10">
              <div className="">
                ...
                <p className=' mt-9 text-lg text-[#686868]'>Join the Banglar Big Store Seller Facebook group for exclusive tips on selling more. <Link href='' className='text-[#287DF3]'>Learn More</Link></p>
              </div>
              ...
              <div className="">
                ...
                <p className=' mt-9 text-lg text-[#686868]'>Directly chat with our Seller Support Team regarding any questions or concerns. <Link href='' className='text-[#287DF3]'>Learn More</Link></p>
              </div>
