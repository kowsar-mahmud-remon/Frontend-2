...
import { useGetAllCategoryForHomePage, useGetAllCategoryForHomePageQuery, useGetCategoryQuery } from '../../features/category/categoryApi';
...
const AllCategory = () => {
    ...
    const { data: categoryData, isLoading: categoryLoading, error: categoryError } = useGetAllCategoryForHomePageQuery()
    ...
    return (
        <>
            ...
            {
                categoryData?.result.map((category, index) => <AllCategoryCard
                    key={index}
