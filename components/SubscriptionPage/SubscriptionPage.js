...
<<<<<<< HEAD
  return (
    <div className="md:mt-[45px] px-[2vw] w-[90%] mx-auto">
      <p className="text-[1.3vw] font-semibold text-[#686868]">
        Home {">"} Account & Setting {">"}{" "}
        <span className="text-[#001E00]">Subscription</span>
      </p>
      ...
      <div className="grid grid-cols-3 w-full gap-[2vw]">
        <div className=" shadow-small relative h-[15vw] rounded-md ">
          <p className="text-center py-[12px] text-[#001E00] text-[1.3vw] font-semibold">
            Product Upload
          </p>
...
>>>>>>> 1350c24c08fc57ec6aad9fa1c9c113fe084e4885
        </div>
        <div className=" shadow-small relative h-[15vw] rounded-md ">
          <p className="text-center py-[12px] text-[#001E00] text-[1.3vw] font-semibold">
            Active Time
          ...
          <div className="flex justify-center mt-[2.1vw] gap-[10px] items-center">
            <div>
              <h1 className="text-[#001E00] text-[1.2vw] text-center">
                9:00:10s
              </h1>
              <h1 className=" text-[1.2vw] text-[#001E00] text-center">
                02/08/2023
              </h1>
            </div>
          </div>
      ...
      <div className="grid grid-cols-3 w-full gap-[2vw] mt-[1.7vw]">
        <div>
          <h1 className="text-[1.3vw] text-[#001E00] mb-[0.9vw]">
            You Active Subscription
          </h1>
          <div className=" shadow-small  rounded-md p-[1.3vw]">
            <p className="py-[12px] mb-[0.9vw] text-[#001E00]  text-[1.3vw] font-semibold">
              Premium Store
            </p>
            <p className="mb-[1.6vw] text-[0.9vw] text-[#686868]">
              For high volume sellers who have an extensive product catalog or
              are running a business that would benefit from dedicated customer
              support.
            </p>
            <p className="text-[2.29vw] text-[#001E00]">
              ৳ 4000 <span className="text-[1.3vw]">/1 month</span>
            </p>
            <p className="text-[0.9vw] text-[#686868] mb-[1.6vw]">
            ...
            <p className="text-[0.9vw] text-[#686868] mb-[1.6vw]">
              ...
              <br />
              18Tk insertion fee for additional listing
            </p>
            <p className="text-[0.9vw] text-[#686868]">
              350/mo
              <br />
              Free auction listings in select categories
              <br />
              15Tk insertion fee for additional listing
            </p>
            <div className="w-[80%] border border-[#287DF3] mx-auto mt-[10vw] rounded-md">
              <h1 className="text-[#287DF3] text-[0.9vw] font-semibold text-center py-[0.6vw]">
                Renewal
              </h1>
            </div>
          </div>
        ...
        <div>
          ...
          <div className=" shadow-small  rounded-md p-[1.3vw]">
            ...
            <p className="mb-[1.6vw] text-[0.9vw] text-[#686868]">
              For enterprise sellers who have an extensive product catalog or
              are running a business that would benefit from dedicated customer
              support.
            </p>
            <p className="text-[2.29vw] text-[#001E00]">
              ৳ 5000 <span className="text-[1.3vw]">/1 month</span>
            </p>
            <p className="text-[0.9vw] text-[#686868] mb-[1.6vw]">
              with annual subscription
            </p>
            ...
            <div className="w-[80%] border border-[#686868] mx-auto mt-[10vw] rounded-md">
              <h1 className="text-[#686868] text-[0.9vw] font-semibold text-center py-[0.6vw]">
                Select starter store
              </h1>
            </div>
          </div>
        </div>
      ...
      {/* Other subscription plan */}
      <div className="mt-[1.7vw]">
        <h1 className="text-[1.2vw] text-[#001E00]">
          Choose Others Subscription Plan
        </h1>
        <div className="grid grid-cols-3 w-full gap-[2vw] mt-[0.8vw]">
          <div>
            <div className=" shadow-small  rounded-md p-[1.3vw]">
              ...
              <p className="mb-[1.6vw] text-[0.9vw] text-[#686868]">
                Best for sellers who have a handful of products and want a
                storefront to brand and promote their business.
              </p>
              <p className="text-[2.29vw] text-[#001E00]">Free </p>
              <p className="text-[0.9vw] text-[#686868] mb-[1.6vw]">
                with annual subscription
              ...
              <p className="text-[0.9vw] text-[#686868] mb-[1.6vw]">
                ...
                Free fixed-price listings
                <br />
                30Tk insertion fee for additional listing
              </p>
          ...
          <div>
            <div className=" shadow-small  rounded-md p-[1.3vw]">
              ...
              <p className="mb-[1.6vw] text-[0.9vw] text-[#686868]">
                Just getting started? Enjoy more free listings, final value fee
                discounts, and a quarterly coupon for eBay-branded shipping
                supplies.
              </p>
              <p className="text-[2.29vw] text-[#001E00]">
                ৳ 2000 <span className="text-[1.3vw]">/1 month</span>
              </p>
              <p className="text-[0.9vw] text-[#686868] mb-[1.6vw]">
                with annual subscription
              </p>
              <p className="text-[0.9vw] text-[#686868] mb-[1.6vw]">
                ...
                Free fixed-price listings
                <br />
                25Tk insertion fee for additional listing
              </p>
              <p className="text-[0.9vw] text-[#686868]">
                150/mo
                <br />
                Free auction listings in select categories
                <br />
                20Tk insertion fee for additional listing
              </p>
          ...
          <div>
            <div className=" shadow-small  rounded-md p-[1.3vw]">
              ...
              <p className="mb-[1.6vw] text-[0.9vw] text-[#686868]">
                If you have an extensive product assortment, a Premium Store
                subscription gives you substantially more zero insertion fee
                listings.
              </p>
              <p className="text-[2.29vw] text-[#001E00]">
                ৳ 3000 <span className="text-[1.3vw]">/1 month</span>
              </p>
              <p className="text-[0.9vw] text-[#686868] mb-[1.6vw]">
                with annual subscription
              </p>
