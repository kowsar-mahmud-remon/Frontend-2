  ...
  return (
    <div className="">
      ...
      <div className="shadow-lg pb-40 px-5 md:pl-10">
        <div className="">
          <h4 className="text-[24px] text-[#FB641B] font-semibold">
          ...
          <div className="flex items-center my-8">
            ...
            <div className="bg-[#FB641B] text-white text-[5px] md:text-[12px] border border-white px-1 rounded-lg">
              2
            </div>
            <div className="bg-[#FB641B] text-white text-[5px] md:text-[12px] px-5 md:px-20 rounded-xl">
              Add Shop Name
            </div>
            <div className="bg-[#FB641B] text-[5px] md:text-[12px] px-1 text-white rounded-lg">
              3
            </div>
            <div className="bg-[#FB641B] text-[5px] md:text-[12px] px-5 md:px-20 text-white rounded-xl">
              Add Shop Name
            </div>
          ...
          <h4 className="text-[24px] font-semibold text-[#686868] my-3">
        ...
        <h4 className="text-[24px] mt-12 font-semibold text-[#686868]">
          Please give your ID & Bank Information
        </h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 my-5">
          <div className="">
            ...
            <input
              ...
              className="input input-bordered md:w-[480px]"
            />
          </div>
          <div className="">
